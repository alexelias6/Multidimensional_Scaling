...
Our three examples will involve briefly cleaning the data, calculating distances among our chosen variables in four 
different ways, performing classical MDS, and plotting the resulting coordinates in two-dimensional space. 
The four measures of distance we will be using are Euclidean, Manhattan, Maximum, and Correlation.
